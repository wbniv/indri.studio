---
title: "Object-oriented C and assembly"
summary: "Vtables, inheritance, and polymorphism in plain C (and assembly) on a 3.58 MHz 65816 — with measured codegen."
app: "llvm-mos-65816"
sourceRepo: "llvm-mos-65816"
sourceCommit: "e9a8663"
order: 6
---
...
exactly how the `snesgfx` rendering library hides the
...
- Methods in another bank ⇒ method pointers are **24-bit far**; the indirect call must use
  ...
  pointer — see §4 of the rendering handoff).
...
the prior-art note) and llvm-mos's own
