...
<DownloadBadges items={[
  { os: "Linux", arch: "arm64", format: "tar.xz", href: "https://apt.indri.studio/sources/llvm-mos-65816_0.0.0+git20260625.bff643e_linux-aarch64.tar.xz" },
  { os: "Windows", arch: "x86-64", format: "zip", note: "early preview", href: "https://apt.indri.studio/sources/llvm-mos-65816_0.0.0+git20260625.bff643e_windows-x86_64.zip" },
