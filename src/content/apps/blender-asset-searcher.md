...
A Blender sidebar panel that searches licensed 3D assets across multiple online providers and records the **provenance** of everything you import — where it came from, who made it, under what terms, and what attribution you owe.
...
- **Search across providers.** Poly Haven, OpenGameArt, Sketchfab, and more — one query, one results list, license badges visible.
